...
class PCModelNetDataLoader(Dataset):
    ...
    def __getitem__(self, index):
        if isinstance(self.PC, PointCloud):
            ...
            return point_set, cls, self.PC.sequence_name, self.PC.H_score, self.PC.per_labels, self.PC.per_mean_label
            ...
            return point_set, cls, self.PC[index].sequence_name, self.PC[index].H_score, self.PC[index].per_labels, self.PC[index].per_mean_label
